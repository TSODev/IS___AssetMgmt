 ...
 */
package fr.tsodev.uiautomation.sample;
...
import  fr.tsodev.uiautomation.sample.steps.TestUIGivenState;
import  fr.tsodev.uiautomation.sample.steps.TestUIThenState;
import  fr.tsodev.uiautomation.sample.steps.TestUIWhenState;
...
public class UIAutomationSuite extends UIBaseTest<TestUIGivenState, TestUIWhenState, TestUIThenState>{
    ...
    // Here Task Manager.
    private final String bundleName = "fr.tsodev.assetmgmt";
